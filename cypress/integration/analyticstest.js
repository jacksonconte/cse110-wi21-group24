describe('Testing the Analytics Page', () => {
    ...
    it('1 task completed test, graph test', () => {
        ...
        cy.get('#svg-label').contains('This was a Cancelled Work Pomo that lasted 3 minutes and 1 seconds.');
        cy.get('#progressRect1').trigger('mouseover');
        cy.get('#svg-label').contains('This was a Work Pomo that lasted 25 minutes and 0 seconds.');
        cy.get('#progressRect2').trigger('mouseover');
        cy.get('#svg-label').contains('This was a Short Break that lasted 5 minutes and 0 seconds.');
        cy.get('#progressRect3').trigger('mouseover');
        cy.get('#svg-label').contains('This was a Work Pomo that lasted 20 minutes and 0 seconds.');
        cy.get('#progressRect4').trigger('mouseover');
        cy.get('#svg-label').contains('This was a Cancelled Short Break that lasted 1 minutes and 40 seconds.');
        cy.get('#progressRect10').trigger('mouseover');
        cy.get('#svg-label').contains('This was a Long Break that lasted 15 minutes and 0 seconds.');
        cy.get('#distRect0').trigger('mouseover');
        cy.get('#svg-label').contains('This was a distraction logged at 2 minutes and 50 seconds in.');
        cy.get('#distRect1').trigger('mouseover');
        cy.get('#svg-label').contains('This was a distraction logged at 16 minutes and 40 seconds in.');
    ...
    it('Multiple completed tasks dropdown test', () => {
        ...
        cy.get('#svg-label').contains('This was a Work Pomo that lasted 25 minutes and 0 seconds.');
        cy.get('#progressRect1').trigger('mouseover');
        cy.get('#svg-label').contains('This was a Short Break that lasted 2 minutes and 0 seconds.');
        cy.get('#progressRect2').trigger('mouseover');
        cy.get('#svg-label').contains('This was a Work Pomo that lasted 16 minutes and 40 seconds.');
        cy.get('#distRect0').trigger('mouseover');
        cy.get('#svg-label').contains('This was a distraction logged at 2 minutes and 50 seconds in.');
        cy.get('#distRect1').trigger('mouseover');
        cy.get('#svg-label').contains('This was a distraction logged at 16 minutes and 40 seconds in.');
        ...
        cy.get('#progressRect1').should('not.exist');
        cy.get('#distRect0').trigger('mouseover');
        cy.get('#svg-label').contains('This was a distraction logged at 3 minutes and 20 seconds in.');
        cy.get('#stat-est-pomo').contains('Estimated Work Pomos: 10');
        cy.get('#stat-act-pomo').contains('Completed Work Pomos: 1');
        cy.get('#stat-distractions').contains('Distractions Logged: 1');
        cy.get('#stat-cancelled-pomo').contains('Cancelled Work Pomos: 0');
